...
class TwitterCSVScraper(DatedScraper):
    ...
    def _get_units(self):
        ...
        index = DictReader(le_file,fieldnames=fields)
        for tweet in index:
            yield tweet
    ...
    def _scrape_unit(self, tweet): 
        ...
        _tweet = Document()
        _tweet.props.text = tweet['text']
        _tweet.props.author = tweet['user']
        _tweet.props.date = readDate(tweet['created_at']).date()
        _tweet.props.restdata = tweet
