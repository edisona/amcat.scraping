...
import re, sys, urllib, codecs, types
...
def name2cp(k):
    ...
    if hasattr(entities, "name2codepoint"): # requires Python 2.3
        return entities.name2codepoint[k]
    else:
        k = entities.entitydefs[k]
...
class _html2text(HTMLParser.HTMLParser):
    ...
    def previousIndex(self, attrs):
        ...
        """
        if not 'href' in attrs: return None
