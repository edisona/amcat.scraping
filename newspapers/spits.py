...
class SpitsKrantScraper(HTTPScraper, DatedScraper):
    ...
    cookie_url = "http://tmgonlinemedia.nl/consent/consent/?return=http%3A%2F%2Fwww.spitsnieuws.nl%2F&clienttime={timestamp}&detect=true"
    ...
    def accept_cookies(self):
        ...
        params = {
            ...
            'detect' : 'true',
            'return' : 'http://www.spitsnieuws.nl/'
            }
        self.open(self.cookie_url, urlencode(params))
